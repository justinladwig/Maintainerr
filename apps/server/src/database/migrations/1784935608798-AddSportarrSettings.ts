...
export class AddSportarrSettings1784935608798 implements MigrationInterface {
  name = 'AddSportarrSettings1784935608798';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "sportarr_settings" (
